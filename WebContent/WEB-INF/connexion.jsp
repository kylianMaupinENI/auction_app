								...
								<div class="col-lg-6">
									<div class="p-5">
										...
										<div class="form-group">
											<label for="<%=ServletUtils.CHAMP_PSEUDO_CONNEXION%>">Identifiant
												:</label> <input type="text" class="form-control form-control-user"
												id="<%=ServletUtils.CHAMP_PSEUDO_CONNEXION%>"
												name="<%=ServletUtils.CHAMP_PSEUDO_CONNEXION%>">
										</div>
										<div class="form-group">
											<label for="<%=ServletUtils.CHAMP_MOT_DE_PASSE_CONNEXION%>">Mot
												de passe :</label> <input type="password"
												class="form-control form-control-user"
												id="<%=ServletUtils.CHAMP_MOT_DE_PASSE_CONNEXION%>"
												name="<%=ServletUtils.CHAMP_MOT_DE_PASSE_CONNEXION%>">
										</div>
										<div class="row">
											<div class="col-lg-6">
												<input type="submit"
