...
public class UtilisateurManager {
	...
	/*
	 * Expression r�guli�re permettant la validation du mot de passe.
	 * 
	 * Pour �tre valide, le mot de passe doit: - �tre compos� d'au moins 8
	 * caract�res. - Contenir au moins une lettre miniscule, une lettre majuscule,
	 * un chiffre et un caract�re sp�cial. - Ne contenir aucun espace ou
	 * tabulations.
	 */
	...
	public void modifieUtilisateur(int noUtilisateur, String pseudo, String nom, String prenom, String email,
		...
		Adresse adresse = new Adresse(rue, codePostal, ville);
		// Nouveaux param�tres de l'utilisateur
